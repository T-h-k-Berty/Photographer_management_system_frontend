...
import {
  Box, Paper, Typography, Avatar, Grid, TextField, MenuItem, Button,
  Divider, InputAdornment, Tooltip, Fade, CircularProgress, Snackbar, Alert
} from "@mui/material";
...
const eventTypes = [
  ...
  "Fashion Shoot", "Portrait", "Anniversary", "Other"
];
...
const BookingForm = () => {
  ...
  // Photographers busy/unavailable dates (from events)
  ...
  useEffect(() => {
    ...
    const fetchPhotographer = async () => {
      try {
        ...
        // fetch unavailable dates (photographer events)
        if (res.data?.userId) {
  ...
  // Only allow picking dates not in busyDates and not in the past
        ...
        <Grid container justifyContent="center" spacing={2}>
          <Grid item xs={12} md={7} lg={6}>
            <Fade in>
              <Box
                sx={{
                  ...theme.card, p: 2.5, mb: 4, display: "flex", alignItems: "center", gap: 2,
                  background: "#181818", border: "2px solid #FFD600", borderRadius: "20px",
                  boxShadow: "0 0 24px 2px #FFD60022", minHeight: 110, position: "relative"
                }}
              >
                {loading ? (
                  ...
                  <Avatar
                    ...
                    sx={{
                      width: 70, height: 70, background: "#FFD600", color: "#181818", fontSize: 44, mr: 2
                    }}
                  >
                ...
                <Box flex={1}>
                  <Typography variant="h6" fontWeight="bold" color="#FFD600" sx={{ letterSpacing: "1.2px", mb: 0.2, fontSize: 22 }}>
                    {photographer ? photographer.shopName || "Photographer Name" : "Photographer Name"}
                  </Typography>
                  <Typography variant="body2" color="#FFFDE7" sx={{ fontWeight: 500, letterSpacing: 0.7, fontSize: 17 }}>
                    {photographer ? photographer.photographerName || "Professional Photographer" : "Professional Photographer"}
                  </Typography>
            ...
            <Paper sx={{ ...theme.formPaper, px: { xs: 2, md: 5 }, py: { xs: 3, md: 5 }, mb: 2 }}>
              <Typography variant="h4" fontWeight="bold" sx={{
                color: "#FFD600", mb: 1, letterSpacing: "1px", textAlign: "center",
              }}>
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} sm={6}>
                    <TextField
                      ...
                      fullWidth required error={!!errors.phone} helperText={errors.phone}
                      InputProps={{
                        startAdornment: (
                          <InputAdornment position="start">
                  ...
                  <Grid item xs={12}>
                    <TextField
                      label="Location (Address)" name="address" value={form.address} onChange={handleChange}
                      fullWidth required error={!!errors.address} helperText={errors.address}
                      InputProps={{
                        startAdornment: (
                          <InputAdornment position="start">
                  ...
                  <Grid item xs={12} sm={6}>
                    <TextField
                      label="Time" name="time" type="time" value={form.time} onChange={handleChange}
                      fullWidth required error={!!errors.time} helperText={errors.time}
                  ...
                  <Grid item xs={12} sm={6}>
                    <TextField
                      ...
                      fullWidth required error={!!errors.eventType} helperText={errors.eventType}
                      InputProps={{
                        startAdornment: (
                          <InputAdornment position="start">
                            <EventAvailableIcon sx={{ color: "#FFD600" }} />
                  ...
                  <Grid item xs={12}>
                    <Tooltip title="Submit Booking" arrow placement="top">
                      <span>
                        <Button
                          type="submit" variant="contained" color="warning" fullWidth
                          sx={{
                            borderRadius: 6, fontWeight: 700, fontSize: 18, letterSpacing: "1px", mt: 2, py: 1.5,
